...
6112511581, -- NghiaGyGy
7668465677, -- NghiaGG88
5741682077, -- Yohox2
7713219599, -- skiiibiiidiii11
}
...
while getgenv().autofarmflare do wait(0)
pcall(function()
local args = {
    [1] = tonumber(serializeTable(remotes)),
    [2] = "FlarePower2",
...
while getgenv().autofarmbom do wait(0)
pcall(function()
local args = {
    [1] = tonumber(serializeTable(remotes)),
    [2] = "BombPower1",
...
while getgenv().autofarmbom2 do wait(0)
pcall(function()
local args = {
    [1] = tonumber(serializeTable(remotes)),
    [2] = "BombPower2",
...
while getgenv().autofarmbom3 do wait(0)
pcall(function()
local args = {
    [1] = tonumber(serializeTable(remotes)),
    [2] = "BombPower4",
...
while getgenv().autofarmbom4 do wait(0)
pcall(function()
local args = {
    [1] = tonumber(serializeTable(remotes)),
    [2] = "BombPower5",
...
while getgenv().ghteqweqwehjrrt do wait(0)
pcall(function()
    for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
        if v.Name == Choose2 then
local args = {
...
while getgenv().ghteqweqwehjt do wait(0)
pcall(function()
    for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
        if v.Name == Choose2 then
local args = {
...
while getgenv().ghteqweqwzehjt do wait(0)
pcall(function()
    for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
        if v.Name == Choose2 then
local args = {
        ...
        for _,v in pairs(game.Workspace.Enemies:GetChildren()) do
            if string.find(v.Name, "Crab") or string.find(v.Name, "Bandit") or string.find(v.Name, "Thief") or string.find(v.Name, "Bruno") or string.find(v.Name, "Bucky") 
             ...
             or string.find(v.Name, "Cave ") or string.find(v.Name, "Thug") or string.find(v.Name, "Gunslinger") or string.find(v.Name, "Gunner") or string.find(v.Name, "Buster")
              and v:FindFirstChild("HumanoidRootPart") then
                v:FindFirstChild("HumanoidRootPart").Anchored = true
                v:FindFirstChild("HumanoidRootPart").CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(5,5,Distance1)
             end
         end
    end)
    end
