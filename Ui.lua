...
tween:Create(MainSceen,TweenInfo.new(0.4,Enum.EasingStyle.Back),{Size = UDim2.new(0, 400, 0, 400)}):Play()
...
Container_Page.Size = UDim2.new(0, 360, 0, 210)
...
function top:Taps(text)
    ...
    MainPage.Size = UDim2.new(0, 360, 0, 280)
    ...
    ScrollingFrame_Pagefrist.BackgroundColor3 = Color3.fromRGB(18, 18, 18) -- 249, 53, 139
    ScrollingFrame_Pagefrist.BorderSizePixel = 0
    ScrollingFrame_Pagefrist.Size = UDim2.new(0, 360, 0, 280)
    ...
    UIGridLayout_Pagefrist.CellSize = UDim2.new(0, 170, 0, 250)
    ...
    function page:newpage()
        ...
        Pageframe.Size = UDim2.new(0, 170, 0, 260)
        ...
        ScrollingFrame_Pageframe.Size = UDim2.new(0, 170, 0, 260)
...
TextButton_Toggle2.MouseButton1Click:Connect(function()
    ...
    if check then
        ...
        SliderFrame.BackgroundColor3 =  Color3.fromRGB(30, 30, 30)-- Color3.fromRGB(249, 53, 139)
...
--        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(249, 53, 139)
    ...
    if use == false then
        ...
        DropFrame.BackgroundColor3 =  Color3.fromRGB(18, 18, 18)-- Color3.fromRGB(249, 53, 139)
...
--     TextLabel_TapDrop.AnchorPoint = Vector2.new(0.5, 0.5)
    ...
    --   ButtonDrop.AnchorPoint = Vector2.new(0.5, 0.5)
        ...
        for i , v in pairs(option) do
            ...
            ListFrame.BackgroundColor3 =  Color3.fromRGB(255, 255, 255)-- Color3.fromRGB(249, 53, 139)
...
--   ButtonDrop.AnchorPoint = Vector2.new(0.5, 0.5)
    ...
    for i , v in pairs(list) do
        ...
        listtog.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
...
ScolDown.CanvasSize = UDim2.new(0,0,0,UIListLayoutlist.AbsoluteContentSize.Y + 10  )
    ...
    function items:TextBox(text,text2,callback)
        ...
        FrameBox.BackgroundColor3 =  Color3.fromRGB(18, 18, 18)
    ...
    TextFrame.MouseLeave:Connect(function()
        ...
        TweenService:Create(
            FrameBox,
            TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {BackgroundColor3 = Color3.fromRGB(18, 18, 18)} -- UDim2.new(0, 128, 0, 25)
        ):Play()
        TweenService:Create(
            TextFrame2,
            TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
    ...
    function items:Bind(text,bi,callback)
        ...
        BindFrame.BackgroundColor3 =  Color3.fromRGB(18, 18, 18)
    ...
    function items:Color(text,preset,callback)
        ...
        Pixker.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
...
OMF.MouseButton1Down:Connect(
    ...
    function items:Label(text,image)
        ...
        LabelFrame.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
