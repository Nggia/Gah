        ...
        function tab:CreateSection(config)
           ...
           sectionStroke.Parent = sectionFrame
            ...
            function section:CreateToggle(config)
                ...
                local toggleSwitch_child = CreateCorner(11
toggleSwitch_child.Parent = toggleSwitch)
                ...
                local toggleSlider_child = CreateCorner(9
toggleSlider_child.Parent = toggleSlider)
            ...
            function section:CreateButton(config)
                ...
                local buttonFrame_child = CreateCorner(6
buttonFrame_child.Parent = buttonFrame)
            ...
            function section:CreateSlider(config)
                ...
                local sliderTrack_child = CreateCorner(3
sliderTrack_child.Parent = sliderTrack)
                ...
                local sliderFill_child = CreateCorner(3
sliderFill_child.Parent = sliderFill)
                ...
                local sliderThumb_child = CreateCorner(7
sliderThumb_child.Parent = sliderThumb)
