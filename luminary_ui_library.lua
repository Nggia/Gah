    ...
    ["win"] = function()
        ...
        function UISetToggle(p44)
            ...
            if p44 then
                ...
                repeat
                    wait()
                until vu25.Size == UDim2.new(0, 553, 0, 466)
                vu42.toggledui = true
                vu8.Enabled = true
            else
                vu42.toggledui = true
        ...
        v45.OnChat = game.ReplicatedStorage.DefaultChatSystemChatEvents.OnMessageDoneFiltering.OnClientEvent:Connect(function(p51)
            ...
            if string.lower(v52) == "." and v53.Name == game.Players.LocalPlayer.Name then
                if game:GetService("CoreGui").RobloxGui.Modules.Luminary.Enabled == true then
                    if game:GetService("CoreGui").RobloxGui.Modules.Luminary.Enabled ~= false then
                        game:GetService("CoreGui").RobloxGui.Modules.Luminary.Enabled = false
                    end
                else
                    game:GetService("CoreGui").RobloxGui.Modules.Luminary.Enabled = true
                end
            end
        end)
