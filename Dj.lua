local ui =  game:GetService("CoreGui"):FindFirstChild("redui") if ui then ui:Destroy() end
	...
	local PresetColor = Color3.fromRGB(0, 170, 255)
	...
	function create:Win(text)
		...
		NameReal.TextColor3 = Color3.fromRGB(230, 230, 230)
		...
		ScrollingFrame_Menubar.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
		...
		ScrollingFrame_Menubar.ScrollBarImageColor3 = Color3.fromRGB(50, 50, 50)
		...
		function create:Notifile(titel,text,delays)
			...
			imagenoti.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
		  ...
		  imagenoti.Image = "https://www.roblox.com/asset-thumbnail/image?assetId=7578496318&width=0&height=0&format=png"
			...
			txdlid.Text = titel
			txdlid.TextColor3 = Color3.fromRGB(230, 230, 230)
			...
			TextNoti.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			TextNoti.Size =UDim2.new(0, 260, 0,25 )
			TextNoti.Font = Enum.Font.GothamBold
			TextNoti.Text = text
			TextNoti.TextColor3 = Color3.fromRGB(25, 25, 25)
	...
	--Time.AnchorPoint = Vector2.new(0.5, 0.5)
		...
		function top:Taps(text)
			...
			Frame_Tap.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			TextLabel_Tap.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			...
			TextButton_Tap.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			TextButton_Tap.TextColor3 = Color3.fromRGB(180, 180, 180)
			...
			ScrollingFrame_Pagefrist.ScrollBarImageColor3 = Color3.fromRGB(50, 50, 50) -- 240, 255, 255
			...
			function page:newpage()
				...
				ScrollingFrame_Pageframe.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				...
				ScrollingFrame_Pageframe.ScrollBarImageColor3 = Color3.fromRGB(120, 120, 120)
			...
			function items:Toggle(text,config,callback)
				...
				TextButton_Toggle.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				...
				TextButton_2_Toggle.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
		--        TextButton_2_Toggle.BorderColor3 = Color3.fromRGB(50, 50, 50)
		...
		--        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(50, 50, 50)
				...
				TextButton_4_Toggle.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
		--        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(50, 50, 50)
				...
				TextLabel_Toggle.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				...
				TextLabel_Toggle.TextColor3 = Color3.fromRGB(230, 230, 230)
				...
				TextButton_Toggle2.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				...
				TextButton_Toggle2.TextColor3 = Color3.fromRGB(230, 230, 230)
				...
				TextButton_Toggle2.MouseEnter:Connect(function()
					...
					TweenService:Create(
						TextLabel_Toggle,
						TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(25, 25, 25)} -- UDim2.new(0, 128, 0, 25)
					):Play()
				end
			)
		...
		TextButton_Toggle2.MouseButton1Click:Connect(function()
				if check.toogle == false and check.loacker == true  then
					TweenService:Create(
						...
						{BackgroundColor3 =  Color3.fromRGB(50, 50, 50)} -- UDim2.new(0, 128, 0, 25)
					):Play()
					TweenService:Create(
						TextButton_3_Toggle,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
					...
					TweenService:Create(
						TextButton_2_Toggle,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{BackgroundColor3 =  Color3.fromRGB(100, 100, 100)} -- UDim2.new(0, 128, 0, 25)
					):Play()
				...
				elseif  check.loacker ==  true then
					TweenService:Create(
						TextButton_4_Toggle,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{BackgroundColor3 =  Color3.fromRGB(180, 180, 180)} -- UDim2.new(0, 128, 0, 25)
					):Play()
					TweenService:Create(
						TextButton_3_Toggle,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function items:Button(text,callback)
				...
				MheeFrameStroke.Color = Color3.fromRGB(50, 50, 50)
				...
				Button.MouseLeave:Connect(function()
					...
					TweenService:Create(
						Button,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(180, 180, 180)} -- UDim2.new(0, 128, 0, 25)
					):Play()
				end
			)
			...
			if check then
				...
				SliderFrame.BackgroundColor3 =  Color3.fromRGB(28, 28, 28)-- Color3.fromRGB(50, 50, 50)
				...
				SliderFrameStroke.Color = Color3.fromRGB(50, 50, 50)
				...
				LabelNameSliderxd.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				...
				LabelNameSliderxd.TextColor3 = Color3.fromRGB(25, 25, 25)
				...
				CustomValue.PlaceholderColor3 = Color3.fromRGB(120, 120, 120)
				...
				CustomValue.TextColor3 = Color3.fromRGB(25, 25, 25)
				...
				PartValue.BackgroundColor3 = Color3.fromRGB(120, 120, 120)
				...
				MainValue.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				...
				ConneValue.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				...
				Addvalue.ImageColor3 =  Color3.fromRGB(50, 50, 50)
				...
				Deletevalue.ImageColor3 =  Color3.fromRGB(50, 50, 50)


				local TextButton_2_Toggle = Instance.new("TextButton")

				TextButton_2_Toggle.Parent = ValueFrame
				TextButton_2_Toggle.BackgroundColor3 = Color3.fromRGB(180, 180, 180)
		--        TextButton_2_Toggle.BorderColor3 = Color3.fromRGB(50, 50, 50)
				TextButton_2_Toggle.BorderSizePixel = 0
				TextButton_2_Toggle.AnchorPoint = Vector2.new(0.5, 0.5)
		...
		--        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(50, 50, 50)
				...
				TextButton_Toggle.BackgroundTransparency =1
				TextButton_Toggle.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				TextButton_Toggle.BorderSizePixel = 0
				...
				TextButton_Toggle.MouseButton1Click:Connect(function()
					if check2.toogle2 == false   then
						...
						TweenService:Create(
							TextButton_2_Toggle,
							TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{BackgroundColor3 =  Color3.fromRGB(230, 230, 230)} -- UDim2.new(0, 128, 0, 25)
						):Play()
						TextButton_3_Toggle:TweenSizeAndPosition(UDim2.new(0, 19, 0, 19), UDim2.new(0.1, 0, 0.5, 0), "Out", "Quad", 0.3, true)
					end
			...
			if use == false then
				...
				DropFrame.BackgroundColor3 =  Color3.fromRGB(23, 23, 23)-- Color3.fromRGB(50, 50, 50)
				...
				DropFrameStroke.Color = Color3.fromRGB(50, 50, 50)
				...
				LabelFrameDrop.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				...
				LabelFrameDrop.Text = ""
				LabelFrameDrop.TextColor3 = Color3.fromRGB(180, 180, 180)
			...
			--   LabelFrameDrop.AnchorPoint = Vector2.new(0.5, 0.5)
				...
				TextLabel_TapDrop.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				...
				TextLabel_TapDrop.TextColor3 = Color3.fromRGB(180, 180, 180)
		...
		--     TextLabel_TapDrop.AnchorPoint = Vector2.new(0.5, 0.5)
				...
				DropArbt_listimage.ImageColor3 = Color3.fromRGB(180, 180, 180)
				...
				ScolDown.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				...
				ButtonDrop.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				ButtonDrop.Size = UDim2.new(0, 213, 0, 30)
				ButtonDrop.Font = Enum.Font.SourceSansSemibold
				ButtonDrop.Text = ""
				ButtonDrop.TextColor3 = Color3.fromRGB(180, 180, 180)
			...
			--   ButtonDrop.AnchorPoint = Vector2.new(0.5, 0.5)
				...
				for i , v in pairs(option) do
					...
					ListFrame.BackgroundColor3 =  Color3.fromRGB(22553, 23, 23)-- Color3.fromRGB(50, 50, 50)
					...
					TextLabel_TapDro2p.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
					...
					TextLabel_TapDro2p.TextColor3 = Color3.fromRGB(180, 180, 180)
					...
					ButtonDrop2.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
					ButtonDrop2.Size = UDim2.new(0, 213, 0, 30)
					ButtonDrop2.Font = Enum.Font.SourceSansSemibold
					ButtonDrop2.Text = ""
					ButtonDrop2.TextColor3 = Color3.fromRGB(180, 180, 180)
				...
				DropFrame.MouseEnter:Connect(function()
					...
					TweenService:Create(
						DropArbt_listimage,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{ImageColor3 = Color3.fromRGB(25, 25, 25)} -- UDim2.new(0, 128, 0, 25)
					):Play()
				end
			)
			...
			DropFrame.MouseLeave:Connect(function()
					...
					TweenService:Create(
						DropArbt_listimage,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{ImageColor3 = Color3.fromRGB(180, 180, 180)} -- UDim2.new(0, 128, 0, 25)
					):Play()
				end
			)
	...
	--     TextLabel_TapDrop.AnchorPoint = Vector2.new(0.5, 0.5)
		...
		--   ButtonDrop.AnchorPoint = Vector2.new(0.5, 0.5)
			...
			for i , v in pairs(list) do
				...
				listtextbutton.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				...
				farmtoglist.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				farmtoglist.BorderColor3 = Color3.fromRGB(50, 50, 50)
				...
				farmtoglist2.BorderColor3 = Color3.fromRGB(50, 50, 50)
				...
				textlist.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				...
				textlist.TextColor3 = Color3.fromRGB(25, 25, 25)
	...
	ScolDown.CanvasSize = UDim2.new(0,0,0,UIListLayoutlist.AbsoluteContentSize.Y + 10  )
			...
			function items:TextBox(text,text2,callback)
				...
				LabelNameSliderxd.Font = Enum.Font.GothamBold
				LabelNameSliderxd.Text = tostring(text)
				LabelNameSliderxd.TextColor3 = Color3.fromRGB(180, 180, 180)
				LabelNameSliderxd.TextSize = 11.000
				...
				TextFrame2.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
				...
				TextFrame2.PlaceholderColor3 = Color3.fromRGB(180, 180, 180)
				TextFrame2.PlaceholderText = text2
				TextFrame2.Text = ""
				TextFrame2.TextColor3 = Color3.fromRGB(180, 180, 180)
				...
				TextFrame.MouseEnter:Connect(function()
					...
					TweenService:Create(
						TextFrame2,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{PlaceholderColor3 = Color3.fromRGB(25, 25, 25)} -- UDim2.new(0, 128, 0, 25)
					):Play()
					TweenService:Create(
						TextFrame2,
						TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			TextFrame.MouseLeave:Connect(function()
				...
				TweenService:Create(
					TextFrame2,
					TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
					{PlaceholderColor3 = Color3.fromRGB(180, 180, 180)} -- UDim2.new(0, 128, 0, 25)
				):Play()
				TweenService:Create(
					TextBoxStroke,
					TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function items:Bind(text,bi,callback)
				...
				LabelBind.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				...
				LabelBind.TextColor3 = Color3.fromRGB(180, 180, 180)
				...
				LabelBind2.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				LabelBind2.Size = UDim2.new(0, 100, 0, 19)
				LabelBind2.Font = Enum.Font.GothamBold
				LabelBind2.Text =  "KEY : "..key
				LabelBind2.TextColor3 = Color3.fromRGB(180, 180, 180)
				...
				LabelBind22.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				LabelBind22.Size = UDim2.new(0, 213, 0, 35)
				LabelBind22.Font = Enum.Font.GothamBold
				LabelBind22.Text =  ""
				LabelBind22.TextColor3 = Color3.fromRGB(180, 180, 180)
			...
			function items:Color(text,preset,callback)
				...
				TextFrameColor.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				...
				TextReal.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
				...
				BoxColor.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	...
	--        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(50, 50, 50)
			...
			TextButton_3_Toggle2.BorderColor3 = Color3.fromRGB(50, 50, 50)
			...
			TextButton_3_Toggle2.TextColor3 = Color3.fromRGB(25, 25, 25)
			...
			OMF.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			ColorSelection.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			HueSelection.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			...
			BTN_XD.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
			BTN_XD.BorderColor3 = Color3.fromRGB(50, 50, 50)
			...
			BTN_XD.Text = "Confirm"
			BTN_XD.TextColor3 = Color3.fromRGB(25, 25, 25)
		...
		OMF.MouseButton1Down:Connect(
			...
			function items:Label(text,image)
				...
				LabelFarm2.TextColor3 = Color3.fromRGB(25, 25, 25)
